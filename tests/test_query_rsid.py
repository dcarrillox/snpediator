...
def rsid_online():
    ...
    return False if columns != columns == {'gene': 'MYL2', 'chr': '12', 'position': '110919145', 'orientation': 'minus', 'reference': 'GRCh38 38.1/141'} or genotypes != {'(C;T)': {'magnitude': 6.2, 'color': 'red', 'summary': 'Familial Hypertrophic Cardiomyopathy'}, '(T;T)': {'magnitude': 0.0, 'color': 'green', 'summary': 'common in clinvar'}} else True
